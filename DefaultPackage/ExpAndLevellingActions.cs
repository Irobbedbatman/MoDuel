...
/// </summary>
public static class ExpAndLevellingActions {
    ...
    /// <summary>
    /// The action to provide an <paramref name="amount"/> of experience to a player. This cannot go above the required for the next level.
    /// </summary>
    [ActionName("GainExp")]
    public static void GainExp(Player player, int amount) {
        ...
        player.Context.SendRequest(new ClientRequest("GainExp", player.Index, player.Exp));
    ...
    public static void LevelUp(Player player) {
        ...
        var trigger = new Trigger("LevelledUp", new SourceCommand(nameof(LevelUp), player), player.Context, TriggerType.Implicit);
