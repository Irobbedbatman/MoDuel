...
public abstract class PackagedCode {
    ...
    /// <summary>
    /// Create an empty fallback <see cref="PackagedCode"/> to use when one could not be loaded.
    /// </summary>
    ...
    protected ICollection<Delegate> GetAllActionsViaTag() {
        ...
        var delegates = actions.Select(BuildDelegate);
    ...
    /// <summary>
    /// The callback once the <see cref="PackagedCode"/> has been fully loaded allow for custom code execution.
    /// </summary>
