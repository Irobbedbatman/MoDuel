...
public class TurnData {
    ...
    /// </summary>
    public readonly TurnData? LastTurn;
    /// <summary>
    ...
    /// <param name="lastTurn">The turn before the newly created one. Null if no turn preceeded.</param>
    public TurnData(Player turnOwner, TurnData? lastTurn = null) {
        Owner = turnOwner;
